...
public class LongestCommonSubsequence {
    ...
    public static void main(String args[]){
	   ...
	   */ System.out.println(lcs.longestCommonSubsequence(str1.toCharArray(), str2.toCharArray(),0,0));
        System.out.println(lcs.lcs(str1.toCharArray(), str2.toCharArray(),0,0));
    }

    public int longestCommonSubsequence(char[] str1 , char[] str2,int len1,int len2){
        ...
        {
            return Math.max(longestCommonSubsequence(str1,str2,len1+1,len2),
